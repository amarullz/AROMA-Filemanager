  ...
  while (1){
    ...
    if ((lt==d->loopTick)&&(pd==d->pushedId)){
      if (ft>15){
        ...
        else if (pd==35) acime2_sendmsg(ctl, 37, 1, 1); /* left */
        else if (pd==36) acime2_sendmsg(ctl, 38, 1, 1); /* up */
        else if (pd==37) acime2_sendmsg(ctl, 40, 1, 1); /* down */
        else if (pd==38) acime2_sendmsg(ctl, 39, 1, 1); /* right */
        else if (!d->on123) {
